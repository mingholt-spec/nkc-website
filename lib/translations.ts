...
const translations = {
  sv: {
    ...
    bekrafta: {
      eventFallback: 'eventet',
      invalidLinkTitle: 'Ogiltig länk',
      invalidLinkMessage: 'Token saknas i länken.',
      serverErrorTitle: 'Serverfel',
      serverErrorMessage: 'Något gick fel. Försök igen om en stund.',
      linkExpiredTitle: 'Länken är inte längre giltig',
      linkExpiredMessage: 'Platsen har redan bekräftats eller länken har gått ut. Kontakta oss om du har frågor.',
      alreadyBookedTitle: 'Platsen är redan bekräftad',
      alreadyBookedMessage: (name: string, campaign: string) => `${name ? `Hej ${name}! ` : ''}Du är redan bokad på ${campaign}. Vi ses där!`,
      confirmedTitle: 'Platsen är bekräftad!',
      confirmedMessage: (name: string, campaign: string) => `${name ? `Hej ${name}! ` : ''}Du är nu bokad på ${campaign}. Vi ses där!`,
      emailSubject: (campaign: string) => `Din plats är bekräftad — ${campaign}`,
      emailHeading: 'Din plats är bekräftad!',
      emailGreeting: (name: string) => `Hej ${name},`,
      emailBody: (campaign: string) => `Din plats på <strong>${campaign}</strong> är nu bekräftad. Vi ser fram emot att träffa dig!`,
      emailFooter: 'Har du frågor? Svara på detta mejl så hjälper vi dig.',
    },
    eventPage: {
      schedule: 'Schema',
  ...
  en: {
    ...
    bekrafta: {
      ...
      invalidLinkMessage: 'Token is missing from the link.',
      serverErrorTitle: 'Server error',
      serverErrorMessage: 'Something went wrong. Please try again shortly.',
      linkExpiredTitle: 'This link is no longer valid',
      linkExpiredMessage: 'The spot has already been confirmed or the link has expired. Contact us if you have questions.',
      alreadyBookedTitle: 'Spot already confirmed',
      alreadyBookedMessage: (name: string, campaign: string) => `${name ? `Hi ${name}! ` : ''}You're already booked for ${campaign}. See you there!`,
      confirmedTitle: 'Spot confirmed!',
      confirmedMessage: (name: string, campaign: string) => `${name ? `Hi ${name}! ` : ''}You're now booked for ${campaign}. See you there!`,
      emailSubject: (campaign: string) => `Your spot is confirmed — ${campaign}`,
      emailHeading: 'Your spot is confirmed!',
      emailGreeting: (name: string) => `Hi ${name},`,
      emailBody: (campaign: string) => `Your spot for <strong>${campaign}</strong> is now confirmed. We look forward to seeing you!`,
      emailFooter: 'Questions? Just reply to this email and we’ll help you out.',
    },
    eventPage: {
      schedule: 'Schedule',
