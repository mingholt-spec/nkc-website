...
export default function ShareButtons({ title, primaryColor = '#e50401', backHref, backLabel }: Props) {
  ...
  const share = (getShareUrl: (url: string, title: string) => string) => {
        ...
        <div className="flex items-center gap-3">
          ...
          {SHARE_TARGETS.map(btn => (
            <button
              ...
              className="w-9 h-9 rounded-full flex items-center justify-center transition-all hover:scale-110 active:scale-95 bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300"
            >
