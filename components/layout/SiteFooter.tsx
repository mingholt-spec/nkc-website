  ...
  return (
    <footer className="border-t mt-auto site-bg" style={{ borderColor: `${txtColor}15` }}>
      <div className="mx-auto px-6 py-10" style={{ maxWidth: theme?.maxWidth || '1280px' }}>
        ...
        {hasClubInfo && (
          <div className="mb-8 flex flex-col md:flex-row items-center md:items-start justify-between gap-4">
            <div className="text-center md:text-left">
              ...
              {addressParts && (
                <p className="text-xs" style={{ color: `${txtColor}d9`, fontFamily: theme?.bodyFont }}>
                  {addressParts}
                </p>
              )}
            </div>
        ...
        {footer?.text && (
          <p className="text-sm mb-6 text-center md:text-left" style={{ color: `${txtColor}d9`, fontFamily: theme?.bodyFont }}>
            {footer.text}
          </p>
        )}
        ...
        <div className="mt-6 pt-6 border-t text-center flex flex-col items-center gap-2" style={{ borderColor: `${txtColor}10` }}>
          {footer?.showPoweredBy !== false && (
            <p className="text-[10px] uppercase tracking-widest" style={{ color: `${txtColor}d9`, fontFamily: theme?.bodyFont }}>
              Powered by{' '}
